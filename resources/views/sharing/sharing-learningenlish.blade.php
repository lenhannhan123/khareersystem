...
<head>
    ...
    <title>Dạy tiếng anh - Khareer Sharing</title>
...
<body>
    <div class="container-fluid" id="mobile-theme">
        ...
        <div class="row" data-aos="zoom-out">
            <div class="col" style="text-align: center;">
                <img src="{{asset("sharing/english/logokhareer-logosharing.png")}}" style="width:10rem" alt="" srcset="">
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col" style="width: 70%;">
                    ...
                    <h1 style="font-size:13pt; margin-right:-2rem ; color: #C46A00;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">khóa học</h1>
                    <h1 style="font-size:13pt; margin-right:-2rem ;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">tiếng anh giao tiếp</h1>
                    <h6 id="description-title-mobile" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        lớp học giao tiếp cho người hướng nội
                        <br/> lớp học giao tiếp cho người hướng ngoại muốn tập trung.
                    </h6>

                    <div class="row" id="div-btn-call-mobile" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        ...
                        <div class="col" style="width: 25%; margin-left: -1rem;">
                            ...
                            <a href="tel:+84909770837">
                                <button id="btn-call-mobile" class="btn
                ...
                <div class="col" style="width: 30%; margin-right: -3rem;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div id="image1-mobile">
                        <img id="image_comp-mobile" src="{{asset("sharing/english/sharing_1.gif")}}" style="width:9rem" alt="" srcset="">
        ...
        <div class="container">
            <div class="row">
                <div class="col" style="width:30%" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                    <img src="{{asset("sharing/english/sharing_2.gif")}}" style="width:7rem" alt="" srcset="">
                </div>
                <div class="col" style="text-align: right; " style="width:70%">
                    <h3 style="font-size:13pt ; color: #C46A00;" data-aos="fade-left" data-aos="fade-up" data-aos-anchor-placement="center-bottom">học phí </h3>
                    <h3 style="font-size:13pt ;margin-left: -4rem; " data-aos="fade-left">chỉ từ 1.000.000/tháng </h3>

                    <div style="font-weight: bold; font-size: 6pt;
                            margin-left: -6rem; " data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        sinh viên các trường đại học chất lượng hàng đầu giảng dạy
                        <br/> lộ trình được thiết kế riêng
                        <br/> lịch học linh động 24/7
                    </div>
        ...
        <div class="container" style="margin-top:2rem ;" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="row">
                <div class="col" style="text-align: center;">
                    <h3 style="font-size:15pt ; color: #C46A00;">nếu bạn cần hỗ trợ </h3>
                </div>
            </div>
        </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            <div class="row" style="margin-top:1rem ;">
                <div class="col" style="text-align: center">
                    <img src="{{asset("sharing/english/sharing_3.gif")}}" style="width:20rem" alt="" srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row" style="margin-top:3rem ;">
                <div class="col-sm-2" data-aos="zoom-out-left" style="width:35%; text-align: center;">
                    ...
                    <img src="{{asset("sharing/english/sharing_imge_1.png")}}" style="width: 6rem; " alt="" srcset="">
                </div>
                    ...
                    <div class="row" style="margin-top: 1rem; margin-left:
                        ...
                        <div class="coll-sm-2">
                            <div id="icon-phone-mobile" data-aos="zoom-out-up">
                                <i class="fas fa-phone" style="font-size:
                                        10pt;"></i>
                            </div>
                        </div>

                        <div class="coll-sm-5">
                            <a href="tel:+84909770837" style="
    ...
    <div class="container-fluid" id="desktop-theme">
        ...
        <div class="row" data-aos="zoom-out">
            <div class="col" style="text-align: center;">
                <img src="{{asset("sharing/english/logokhareer-logosharing.png ")}}" style="width:15rem" alt="" srcset="">
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-sm-9" style="margin-left: -5rem;">
                    ...
                    <h1 style="font-size:50pt ; color: #C46A00;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">khóa học</h1>
                    <h1 style="font-size:50pt ;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">tiếng anh giao tiếp </h1>
                    <h4 id="description-title" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        lớp học giao tiếp cho người hướng nội
                        <br> lớp học giao tiếp cho người hướng ngoại muốn tập trung
                    </h4>
                    <div class="row" id="div-btn-call" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        <div class="col-sm-8">
                            <div style="text-align:center ; font-weight:
                                        bold; font-size: 14pt;">
                                đừng ngại gọi cho chúng tôi ngay lúc này</div>
                ...
                <div class="col" style="margin-right: -15rem;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div id="image1">
                        <img id="image_comp" src="{{asset("sharing/english/sharing_1.gif")}}" style="width:30rem" alt="" srcset="">
        ...
        <div class="container">
            <div class="row">
                <div class="col" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <img src="{{asset("sharing/english/sharing_2.gif")}}" style="width:20rem" alt="" srcset="">
                </div>
                <div class="col-sm-8" style="text-align: right; ">
                    <h3 style="font-size:50pt ; color: #C46A00;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">học phí
                    </h3>
                    <h3 style="font-size:50pt ; " data-aos="fade-left">chỉ từ 1.000.000/tháng
                    </h3>
                    <div style="font-weight: bold; font-size: 14pt;
                                width: 80%; margin-left: 20%;" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        sinh viên các trường đại học chất lượng hàng đầu giảng dạy
                        <br/> lộ trình được thiết kế riêng
                        <br/> lịch học linh động 24/7
                    </div>
        ...
        <div class="container" style="margin-top:5rem ;" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="row">
                <div class="col" style="text-align: center;">
                    <h3 style="font-size:50pt ; color: #C46A00;">nếu bạn cần hỗ trợ </h3>
                </div>
            </div>
        </div>
        <div class="container" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            <div class="row" style="margin-top:3rem ;">
                <div class="col" style="text-align: center">
                    <img src="{{asset("sharing/english/sharing_3.gif")}}" alt="" srcset="">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="margin-top:3rem ;">
                <div class="col" data-aos="zoom-out-left" style="text-align:center ;">
                    <img src="{{asset("sharing/english/sharing_imge_1.png")}}" style="width:
                                15rem;" alt="" srcset="">
                </div>
