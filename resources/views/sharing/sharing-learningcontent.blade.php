...
<head>
    ...
    <title>Dạy content - Khareer Sharing</title>
...
<body>
    <div class="container-fluid" id="mobile-theme">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col" style="width: 70%;">
                    ...
                    <h1 style="font-size:13pt; margin-right:-2rem ;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">viết content cơ bản</h1>
                    <h6 id="description-title-mobile" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        viết ngắn thì bị chê sơ sài 
                        <br/>
                        viết dài thì bị chê dài dòng
                        <br/>
                        vậy viết sao cho đủ???
                    </h6>
                ...
                <div class="col" style="width: 30%; margin-right: -3rem;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div id="image1-mobile">
                        <img id="image_comp-mobile" src="{{asset("sharing/content/sharing_1.png")}}" style="width:9rem" alt="" srcset="">
        ...
        <div class="container">
            <div class="row">
                <div class="col" style="width:30%" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                    <img src="{{asset("sharing/content/sharing_2.png")}}" style="width:7rem" alt="" srcset="">
                </div>
                <div class="col" style="text-align: right; " style="width:70%">
                    ...
                    <h3 style="font-size:13pt ;margin-left: -4rem; " data-aos="fade-left">600.000/khóa/4 buổi </h3>

                    <div style="font-weight: bold; font-size: 6pt;
                            margin-left: -6rem; " data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                         - lớp học 3:1 
                         <br/>
                         - được thực hành từ những dự án thực tế 
                         <br/>
                         - sử dụng các tool hỗ trợ hoạt động viết content​ 
                    </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            <div class="row" style="margin-top:1rem ;">
                <div class="col" style="text-align: center">
                    <img src="{{asset("sharing/content/sharing_3.gif")}}" style="width:20rem" alt="" srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row" style="margin-top:3rem ;">
                <div class="col-sm-2" data-aos="zoom-out-left" style="width:35%; text-align: center;">
                    ...
                    <img src="{{asset("sharing/content/sharing_4.png")}}" style="width: 6rem; " alt="" srcset="">
                </div>
    ...
    <div class="container-fluid" id="desktop-theme">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9" style="margin-left: -5rem;">
                    ...
                    <h1 style="font-size:50pt ;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">viết content cơ bản </h1>
                ...
                <div class="col" style="margin-right: -15rem;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div id="image1">
                        <img id="image_comp" src="{{asset("sharing/content/sharing_1.png")}}" style="width:30rem" alt="" srcset="">
        ...
        <div class="container">
            <div class="row">
                <div class="col" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <img src="{{asset("sharing/content/sharing_2.png")}}" style="width:20rem" alt="" srcset="">
                </div>
                <div class="col-sm-8" style="text-align: right; ">
                    <h3 style="font-size:50pt ; color: #C46A00;" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">học phí
                    </h3>
                    <h3 style="font-size:50pt ; " data-aos="fade-left">600.000/khóa/4 buổi
                    </h3>
        ...
        <div class="container" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            <div class="row" style="margin-top:3rem ;">
                <div class="col" style="text-align: center">
                    <img src="{{asset("sharing/content/sharing_3.gif")}}" alt="" srcset="">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="margin-top:3rem ;">
                <div class="col" data-aos="zoom-out-left" style="text-align:center ;">
                    <img src="{{asset("sharing/content/sharing_4.png")}}" style="width:
                                15rem;" alt="" srcset="">
                </div>
